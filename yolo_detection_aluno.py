...
<seu código>   # Biblioteca para utilizar o modelo YOLO.
<seu código>   # Importando todas as funções de um arquivo chamado 'funcoes'.
<seu código>   # OpenCV, uma biblioteca para processamento de imagem e visão computacional.
